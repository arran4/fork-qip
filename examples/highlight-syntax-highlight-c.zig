...
// TODO: To use StaticStringMap as a "set" (a collection of unique strings), you initialize it with void as the value type and pass empty tuples as values for each key.
const KeywordSet = std.StaticStringMap(u8).initComptime(.{
    .{ "auto", 1 },
    .{ "break", 1 },
    .{ "case", 1 },
    .{ "const", 1 },
...
const TypeSet = std.StaticStringMap(u8).initComptime(.{
    .{ "void", 1 },
    .{ "char", 1 },
    .{ "short", 1 },
    .{ "int", 1 },
...
const LiteralSet = std.StaticStringMap(u8).initComptime(.{
    .{ "NULL", 1 },
    .{ "true", 1 },
    .{ "false", 1 },
});
